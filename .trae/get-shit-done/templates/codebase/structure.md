...
- Usage: Reference from command with `@C:/projects/personal/lexcv/.trae/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/projects/personal/lexcv/.trae/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/projects/personal/lexcv/.trae/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
