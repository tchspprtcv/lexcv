...
```bash
INIT=$(node "C:/projects/personal/lexcv/.trae/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/projects/personal/lexcv/.trae/get-shit-done/templates/spec.md.
