...
Key references:
- @C:/projects/personal/lexcv/.trae/get-shit-done/references/ui-brand.md (display patterns)
- @C:/projects/personal/lexcv/.trae/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/projects/personal/lexcv/.trae/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/projects/personal/lexcv/.trae/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/projects/personal/lexcv/.trae/get-shit-done/USER-PROFILE.md" "C:/projects/personal/lexcv/.trae/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/projects/personal/lexcv/.trae/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/projects/personal/lexcv/.trae/get-shit-done/references/user-profiling.md`
...
Reference: @C:/projects/personal/lexcv/.trae/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/projects/personal/lexcv/.trae/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .trae/rules/" -- "Add profile to C:/projects/personal/lexcv/.trae/.trae/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/projects/personal/lexcv/.trae/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/projects/personal/lexcv/.trae/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/projects/personal/lexcv/.trae/.trae/rules/"
...
```bash
BACKUP_PATH="C:/projects/personal/lexcv/.trae/USER-PROFILE.backup.md"
```
...
Your profile:    C:/projects/personal/lexcv/.trae/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/projects/personal/lexcv/.trae/skills/gsd-dev-preferences/SKILL.md
  ✓ .trae/rules/ section       .trae/rules/
  ✓ Global .trae/rules/        C:/projects/personal/lexcv/.trae/.trae/rules/
```
