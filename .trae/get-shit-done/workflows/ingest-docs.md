...
```bash
INIT=$(node "C:/projects/personal/lexcv/.trae/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/projects/personal/lexcv/.trae/get-shit-done/bin/gsd-tools.cjs" commit \
