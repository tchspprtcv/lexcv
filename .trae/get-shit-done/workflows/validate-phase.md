...
```
Agent(
  prompt="Read C:/projects/personal/lexcv/.trae/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/projects/personal/lexcv/.trae/get-shit-done/templates/VALIDATION.md`
