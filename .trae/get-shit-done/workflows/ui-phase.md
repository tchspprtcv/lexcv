...
```markdown
Read C:/projects/personal/lexcv/.trae/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/projects/personal/lexcv/.trae/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/projects/personal/lexcv/.trae/agents/gsd-ui-checker.md for instructions.
