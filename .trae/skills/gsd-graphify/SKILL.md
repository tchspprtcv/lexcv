...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-sdk query`. Use `node C:/projects/personal/lexcv/.trae/get-shit-done/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-sdk query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node C:/projects/personal/lexcv/.trae/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node C:/projects/personal/lexcv/.trae/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node C:/projects/personal/lexcv/.trae/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```bash
node "C:/projects/personal/lexcv/.trae/get-shit-done/bin/gsd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "C:/projects/personal/lexcv/.trae/get-shit-done/bin/gsd-tools.cjs" graphify build snapshot \
  && node "C:/projects/personal/lexcv/.trae/get-shit-done/bin/gsd-tools.cjs" graphify status
```
