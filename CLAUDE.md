...
- Roles/permissions/default users are seeded in `backend/.../seed/DatabaseSeeder.java` (roles: ADMIN, ADVOGADO, TECNICO, ASSISTENTE). Default admin: `admin@alcv.cv` / `Pa$$w0rd`.
