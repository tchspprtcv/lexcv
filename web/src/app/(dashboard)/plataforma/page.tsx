...
export default function PlataformaPage() {
  ...
  //
  // WR-03 (Phase 120 code review): este ecra precisa de um branch para
  // `!me.isFetched` que ainda nao renderize nada. Sem ele, ANTES do primeiro
  // resolve de useMe() (o estado
  ...
  //
  // Nota (fecho do v2.17): este comentario dizia que a condicao unica
  // `isFetched && !canX` era "usada no resto do codebase (ver clientes/page.tsx)".
  // Deixou de ser verdade -- o seguimento da WR-03 generalizou este mesmo padrao
  // as restantes 25 paginas do dashboard, pelo que ja nao ha aqui excepcao
  // alguma: todas verificam `!isFetched` primeiro.
  const me = useMe();
