...
function ClientesPageContent({
  ...
  // only called when the seed key actually changes (tracked via lastSeededQ), so it re-seeds on
  // a new ?q= navigation but never fights the user's own edits to the search box.
  ...
  // `q` alone — otherwise re-clicking "Ver Todos Clientes" with the same search term would not
