...
```bash
INIT=$(node "C:/Users/francisco.horta/Documents/projects/personal/lexcv/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/francisco.horta/Documents/projects/personal/lexcv/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
