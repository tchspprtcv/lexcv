...
The keys live in `.claude/settings.json` (project) or `C:/Users/francisco.horta/Documents/projects/personal/lexcv/.claude/settings.json` (global) — **not** in `.planning/config.json`:
