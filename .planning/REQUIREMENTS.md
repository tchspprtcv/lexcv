...
- [x] **NTF-28**: Novo menu de utilizador na topbar usa `DropdownMenu`
...
- [x] **LDG-18**: Secções Hero e Contacto reestruturadas com composição `Card`/`Badge`, replicando o padrão já idiomático do `TrustSection`
