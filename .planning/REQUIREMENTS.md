...
- [ ] **CLI-06**: Dados de identificação do cliente são aplanados na BD e o armazenamento em card JSON (`dados_tipo`) é totalmente removido
...
- [ ] **CLI-09**: O tipo de identificação para Empresa deve ser `REG_COMERCIAL` no campo `documento_tipo` e o número correspondente registado em `documento_numero`
...
|-------------|-------|--------|
| CLI-05 | Phase 72 | Pending |
| CLI-06 | Phase 70 | Pending |
| CLI-07 | Phase 72 | Pending |
| CLI-08 | Phase 72 | Pending |
| CLI-09 | Phase 70 | Pending |
