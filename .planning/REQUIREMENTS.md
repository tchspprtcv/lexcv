...
| PROV-05 | Phase 120 | Pending (mecanismo de aplicação backend pronto — Plan 01 — mas a capacidade de um administrador de plataforma efetivamente suspender via endpoint/UI só fecha com os Plans 02/05) |
