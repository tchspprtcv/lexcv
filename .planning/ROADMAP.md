...
Plans:
- [x] 73.1-01-PLAN.md — Remover sync legado de NIF nos 2 formulários; adicionar @NotBlank/@Pattern a Cliente.nif + @Valid nos endpoints; remover sync backend; gates de build/typecheck
