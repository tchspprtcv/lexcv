...
- [x] 34-01-PLAN.md — Backend: AuditLog entity + repository, TimelineItemDto DTO, Movimentacao.autor_id, GET /timeline + GET /audit endpoints, four audit injection points in ResourceController
...
- [x] 34-03-PLAN.md — Frontend UI: tab system restructure (Timeline default, Auditoria RBAC-gated, Movimentacoes removed), dot-and-line feed, client-side filters, checkpoint
