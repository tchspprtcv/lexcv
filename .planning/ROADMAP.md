...
- [ ] 99-01-PLAN.md — Scaffold, config & theme shell: app standalone `webpage/` (package.json subconjunto pinado de web/, next.config assetPrefix `/landing-static` + standalone, providers theme-only, layout, Button/Card/ThemeToggle/cn byte-for-byte) + page placeholder (LP-03, LP-12)
...
| 99. webpage/ — Nova App Next.js de Landing | v2.12 | 0/4 | Planned | - |
