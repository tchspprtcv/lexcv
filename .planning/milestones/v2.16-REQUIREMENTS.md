# Requirements Archive: v2.16 Distribuição Multi-Tenant e Faturação por Utilizadores
...
- [x] **PROV-01**: Papel `PLATAFORMA_ADMIN`, distinto do `ADMIN` de cada escritório, associado a uma tenant reservada "ALCv"
...
- [x] **ISOL-01**: Landing pública mostra sempre marca genérica ALCv (deixa de tentar mostrar branding "da" tenant)
