...
- [x] 119-03-PLAN.md — Contenção do papel de plataforma em `AdminController`: um ADMIN de escritório não pode atribuir, promover, ver nem alterar `PLATAFORMA_ADMIN`
