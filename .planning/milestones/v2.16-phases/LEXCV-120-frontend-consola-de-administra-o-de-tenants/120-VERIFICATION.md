...
| Suspending reserved "ALCv" tenant rejected with `400` + explicit message | ✓ | `:176-178`; `setTenantAtivo_comFalseSobreLexCVDevolve400ComMensagemExataENuncaChamaSave` |
...
| Reserved "ALCv" row shows "Plataforma" badge + disabled suspend w/ tooltip | ✓ | `columns.tsx:139-143,61-82` |
