...
# Requirements: ALCv — Milestone v2.15
...
- [x] **SIJ-01**: PROJECT.md descreve o ALCv sem menção a "NOSi", referenciando o SIJ (Sistema Judicial de Cabo Verde) como ecossistema-alvo
...
| Integração técnica real com o SIJ (API, troca de dados, autenticação) | Esta milestone é exclusivamente de posicionamento/copy — corrige como o ALCv se descreve, não constrói nenhuma integração nova com o sistema judicial |
